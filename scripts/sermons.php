...
<div class="w3-card-2 w3-display-container" style="height:130px;margin-top:24px;"  data-aos="zoom-in">
  <img src="img/ngenda.jpg" alt="" style="height:130px;width:100%;"/>
	...
	PREACHER:  <strong style="color:#0099cc;;"><?php echo $album_   ?> </strong> <br/>  
